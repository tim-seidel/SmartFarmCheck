const events = [
    {
        id: "1",
        startDate: "2020-06-04T16:00:00",
        endDate: "2020-06-04T18:00:00",
        ...
        <p>Die Online-Veranstaltung findet am Donnerstag, den 04. Juni 2020 statt und beginnt um 16:00 Uhr. Ab 15:45 Uhr wird ein Beitritt in den virtuellen Veranstaltungsraum möglich sein.</p>
        <p>Veranstaltungsablauf:</p>
        <ul>
        <li>Begrüßung und Einstimmung auf das Thema | Prof. Dr.-Ing. Clemens Westerkamp (Hochschule Osnabrück) &amp; Dr.-Ing. Alfred J.H. Schoo (VDI BV Osnabrück-Emsland e.V.)</li>
        <li>Künstliche Intelligenz – eine Einordnung | Prof. Dr. rer. nat. Theodor Gervens (Hochschule Osnabrück)</li>
        <li>Angewandte Forschung zur Prozess- und Energiebedarfsoptimierung | Prof. Dr.-Ing. Hans-Jürgen Pfisterer (Kompetenzzentrum Elektronik &amp; Antriebstechnik (KEA), Hochschule Osnabrück)</li>
        <li>Predictive Maintenance (Vorausschauende Wartung) | Dipl.-Ing. FH Thorsten Beling (Abacus Maschinenbau GmbH)</li>
    ...
    },
    {
        ...
        <p>Die Inhalte im Überblick:</p>
        <ul>
        <li>Vorstellungsrunde</li>
        <li>Kurzvortrag: &#8222;Chatbots und Künstliche Intellligenz&#8220;</li>
        <li>Einsatzbereiche und Potentiale von Chatbots</li>
        <li>Individuelle Konzeption eines Chatbots</li>
        <li>Nutzung und Test eines Chatbots</li>
        <li>Abschluss und Evaluation</li>
        </ul>
        <p>&nbsp;</p>
        <p>Um eine intensive Arbeitsphase gewährleisten zu können ist die Teilnehmeranzahl begrenzt. Die Teilnahme ist kostenlos.</p>
        <p>&nbsp;</p>
        <p>Eine Anmeldung pro Unternehmen reicht aus.</p>"`,
        url: 'https://kompetenzzentrum-lingen.digital/termin/chatbots-erfolgreich-konzipieren-und-umsetzen'
    },
]
